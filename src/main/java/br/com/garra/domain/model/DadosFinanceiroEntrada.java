...
public record DadosFinanceiroEntrada (@NotNull double valor, Long alunoId, @NotNull LocalDateTime data, @NotNull LocalDateTime dataVencimento, @NotNull String descricao, @NotNull FinanceiroEntradaCategoria categoria, StatusMensalidade statusMensalidade){
